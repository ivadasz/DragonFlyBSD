...
#define	nosys	linux_nosys
	...
	{ AS(linux_lstat64_args), (sy_call_t *)sys_linux_lstat64 },	/* 6 = linux_lstat64 */
	{ AS(poll_args), (sy_call_t *)sys_poll },	/* 7 = poll */
	{ AS(linux_lseek_args), (sy_call_t *)sys_linux_lseek },	/* 8 = linux_lseek */
	{ AS(linux_mmap2_args), (sy_call_t *)sys_linux_mmap2 },	/* 9 = linux_mmap2 */
	{ AS(mprotect_args), (sy_call_t *)sys_mprotect },	/* 10 = mprotect */
	{ AS(munmap_args), (sy_call_t *)sys_munmap },	/* 11 = munmap */
	...
	{ AS(linux_access_args), (sy_call_t *)sys_linux_access },	/* 21 = linux_access */
	...
	{ AS(linux_clone_args), (sy_call_t *)sys_linux_clone },	/* 56 = linux_clone */
	...
	{ AS(linux_wait4_args), (sy_call_t *)sys_linux_wait4 },	/* 61 = linux_wait4 */
	...
	{ AS(linux_fcntl64_args), (sy_call_t *)sys_linux_fcntl64 },	/* 72 = linux_fcntl64 */
	...
	{ AS(linux_getcwd_args), (sy_call_t *)sys_linux_getcwd },	/* 79 = linux_getcwd */
	...
	{ 0, (sy_call_t *)sys_linux_getuid },		/* 102 = linux_getuid */
	{ 0, (sy_call_t *)sys_nosys },			/* 103 = syslog */
	{ 0, (sy_call_t *)sys_linux_getgid },		/* 104 = linux_getgid */
	{ 0, (sy_call_t *)sys_nosys },			/* 105 = setuid */
	{ 0, (sy_call_t *)sys_nosys },			/* 106 = setgid */
	{ 0, (sy_call_t *)sys_geteuid },		/* 107 = geteuid */
	{ 0, (sy_call_t *)sys_getegid },		/* 108 = getegid */
	{ AS(setpgid_args), (sy_call_t *)sys_setpgid },	/* 109 = setpgid */
	{ 0, (sy_call_t *)sys_linux_getppid },		/* 110 = linux_getppid */
	{ 0, (sy_call_t *)sys_getpgrp },		/* 111 = getpgrp */
	{ 0, (sy_call_t *)sys_setsid },			/* 112 = setsid */
	...
	{ AS(linux_sys_futex_args), (sy_call_t *)sys_linux_sys_futex },	/* 202 = linux_sys_futex */
	...
	{ AS(linux_exit_group_args), (sy_call_t *)sys_linux_exit_group },	/* 231 = linux_exit_group */
	...
	{ AS(linux_set_robust_list_args), (sy_call_t *)sys_linux_set_robust_list },	/* 273 = linux_set_robust_list */
	{ AS(linux_get_robust_list_args), (sy_call_t *)sys_linux_get_robust_list },	/* 274 = linux_get_robust_list */
